...
merged = keras.layers.concatenate([temp_max_input,temp_min_input,precipitacao_total_input])
...
model = Model(inputs=[temp_max_input,temp_min_input,precipitacao_total_input], outputs=[temp_max_output,temp_min_output])

model.compile(loss='mean_squared_error', optimizer='sgd')


model.fit({ 'temp_max_input': train_temp_max_X, 'temp_min_input': train_temp_min_X, 'precipitacao_total_input': train_precipitacao_total_X}, {'temp_max_output': train_temp_max_Y, 'temp_min_output': train_temp_min_Y}, epochs=200, verbose=2, batch_size=2)
...
# gerar predições
trainPredict = model.predict({'temp_max_input': train_temp_max_X, 'temp_min_input': train_temp_min_X, 'precipitacao_total_input':train_precipitacao_total_X},batch_size=2)
testPredict = model.predict({'temp_max_input':test_temp_max_X,'temp_min_input':test_temp_min_X, 'precipitacao_total_input': test_precipitacao_total_X},batch_size=2)
...
address = "precipitacao/{}.xlsx".format(num_neuronio_oculto)
#data.to_csv(address)
