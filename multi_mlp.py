...
x = Dense(1,activation=ativacao)(merged)
...
model.fit({ 'umidade_media_input': train_umidade_media_X ,'temp_max_input': train_temp_max_X, 'temp_min_input': train_temp_min_X}, {'temp_max_output': train_temp_max_Y, 'temp_min_output': train_temp_min_Y}, nb_epoch=100, verbose=2, batch_size=2)
